...
/**/
object ScalaPage extends BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with play.twirl.api.Template0[play.twirl.api.HtmlFormat.Appendable] {

  /**/
  def apply():play.twirl.api.HtmlFormat.Appendable = {
      _display_ {

Seq[Any](_display_(/*1.2*/main("Scala Programming Language")/*1.36*/{_display_(Seq[Any](format.raw/*1.37*/("""
  """),format.raw/*2.3*/("""<div class="row">
    ...
    <div class="col-sm-4"><img class="img-responsive" src=""""),_display_(/*23.61*/routes/*23.67*/.Assets.versioned("img/scala-logo.png")),format.raw/*23.106*/("""" style="padding-top: 30%;" class="img-rounded" alt="Cinque Terre" width="304" height="236"></div>
  </div>
