...
/**/
object GroovyPage extends BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with play.twirl.api.Template0[play.twirl.api.HtmlFormat.Appendable] {

  /**/
  def apply():play.twirl.api.HtmlFormat.Appendable = {
      _display_ {

Seq[Any](_display_(/*1.2*/main("Groovy Programming Language")/*1.37*/{_display_(Seq[Any](format.raw/*1.38*/("""
    """),format.raw/*2.5*/("""<div class="row">
        ...
        <div class="col-sm-4"><img class="img-responsive" src=""""),_display_(/*23.65*/routes/*23.71*/.Assets.versioned("img/groovy.png")),format.raw/*23.106*/("""" style="padding-top: 30%;" class="img-rounded" alt="Cinque Terre" width="304" height="236"></div>
    </div>
